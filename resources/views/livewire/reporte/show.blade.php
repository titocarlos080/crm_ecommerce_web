    ...
    <div>
        ...
        <div class="d-flex flex-row justify-content-between ">
            <div class="m-1">
                ...
                <input class="cursor-pointer" type="date" name="fecha_inferior">
                <label for="">hasta:</label>
                <input class="cursor-pointer" type="date" name="fecha_superior">
            ...
            <div>
                ...
                <button wire:click="exportarPDF" class="btn btn-danger  m-1" data-toggle="tooltip" data-placement="top" title="generar en pdf"><i class="fa fa-file-pdf"> GENERAR PDF</i></button>
            </div>
        </div>
